...
class BaseAdapter (private val context: Context, private val arrayList: ArrayList<BaseDataModel>) : BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val number = view.findViewById<TextView>(R.id.description)
